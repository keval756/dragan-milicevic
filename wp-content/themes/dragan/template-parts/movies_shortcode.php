 <section class="movies">
        <div class="container">
            ...
            <div class="category-title">
                ...
                <a href="<?php echo get_site_url(); ?>/movies" class="yellow-btn d-none d-sm-block">View All</a>
            </div>
            <div class="row">
            <?php $i=1; ?>
           ...
           <?php  $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $the_query->ID ), "post-image" ); ?>
            ...
            <div class="category-view d-block d-sm-none">
                <a href="<?php echo get_site_url(); ?>/movies/" class="yellow-btn">View All</a>
            </div>
        </div>
    </section>